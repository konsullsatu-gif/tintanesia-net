...
// Variables
const rootDomain = "konsullsatu.workers.dev"; // Ganti dengan domain utama kalian
const serviceName = "tintanesia-net"; // Ganti dengan nama workers kalian
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Tintanesia</span>");
